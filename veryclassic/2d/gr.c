...
extern unsigned char * gr_video_memory; // (unsigned char *)0xA0000;
...
*/
	w = 320; r = 320; h = 200; t=BM_LINEAR; data = (intptr_t)gr_video_memory;
...
int gr_init(int mode)
{
	...
	int org_gamma = gr_palette_get_gamma();
	gr_palette_set_gamma( 0 );

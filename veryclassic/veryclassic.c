...
void digi_play_sample_3d(int sndnum, int angle, int volume, int no_dups ) {
	...
	if (play) {
		//printf("play %p %d %d\n", play, sndnum, gsndnum);
		play(gsndnum, angle, fixmuldiv(volume, digi_volume, 0x8000));
		//printf("play done\n");
	}
}
...
void dpmi_modify_selector_base() {}


fix mouse_button_down_time() { return 0; }
fix joy_get_button_down_time() { return 0; }
int joy_get_button_down_cnt() { return 0; }
int joy_get_button_state() { return 0; }
int mouse_button_down_count() { return 0; }
int mouse_get_btns() { return 0; }
int mouse_get_delta() { return 0; }
int joystick_read_raw_axis() { return 0; }
int victor_read_headset_filtered() { return 0; }
int iglasses_read_headset() { return 0; }
int joy_get_scaled_reading() { return 0; }
int mouse_button_state() { return 0; }
int mouse_get_cyberman_pos() { return 0; }
void joy_set_btn_values() {}
int joy_get_cal_vals() { return 0; }
...
int joy_present() { return 0; }


void state_save_all() {}
void state_save_old_game() {}
...
void joy_set_cen() {}
int joy_get_present_mask() { return 0; }
